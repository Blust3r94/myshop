...
export default async function CatalogoPage({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <h1 className="mb-6 text-2xl font-bold">Catalogo</h1>

      <div className="mb-6 flex flex-wrap gap-4 text-sm">
        <Link href="/prodotti" className={!categoria ? "font-semibold underline" : "text-gray-500"}>
          Tutti
        </Link>
        {categories.map((category) => (
          <Link
            ...
            className={category === categoria ? "font-semibold underline" : "text-gray-500"}
          >
            {category}
          </Link>
        ))}
